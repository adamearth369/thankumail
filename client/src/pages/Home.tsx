...
export default function Home() {
  // We can’t rely on CreateGiftForm to render the “delivered” view correctly
  // unless it shares state with Home. So we provide an optional “last created”
  // banner using localStorage, which works even after refresh.
  //
  // This does NOT break your current CreateGiftForm UI — it just adds a correct
  // link block when we have a recent publicId saved.
